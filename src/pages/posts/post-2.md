...
Quick reminder: react is one-way data binding library, that detects DOM elements that need to be updated by _comparing_ tracked data (state and props of a component). In other words, the rule is more or less that the component is rendered when:
